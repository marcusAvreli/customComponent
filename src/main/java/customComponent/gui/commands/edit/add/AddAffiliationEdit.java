...
public class AddAffiliationEdit extends KnowledgeBaseEdit {
  ...
  /*                        Private attributes                               */
  /***************************************************************************/
	private static final Logger logger = LoggerFactory.getLogger(AddAffiliationEdit.class);
  /**
      ...
      if (this.fullAffilliation == null) {
        ...
        this.errorMessage = "An Affiliation yet exists with this full affiliation.";
    	  ...
    	  if(null == CurrentProject.getInstance()) {
    		  logger.info("checkPost_3.1.1");
    	  }
    	  if(null == CurrentProject.getInstance().getFactoryDAO()) {
    		  logger.info("checkPost_3.1.1");
    	  }
    	  if(null == CurrentProject.getInstance().getFactoryDAO().getAffiliationDAO()) {
    		  logger.info("checkPost_3.1.2");
    	  }
