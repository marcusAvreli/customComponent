...
import customComponent.gui.components.detailspanel.AffiliationDetailPanel;
...
public class AffiliationGlobalSlavePanel extends GlobalSlavePanel<Affiliation> {
	...
	private static final Logger logger = LoggerFactory.getLogger(AffiliationGlobalSlavePanel.class);
