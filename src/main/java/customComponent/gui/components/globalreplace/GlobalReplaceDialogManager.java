...
public class GlobalReplaceDialogManager {
  ...
  private GlobalReplaceDialog reportGlobalReplaceDialog;
  ...
  public void init(JFrame frame) {
    ...
    this.reportGlobalReplaceDialog = new GlobalReplaceDialog(frame, new GlobalReplaceReportPanel());
  ...
  public void showGlobalReportGlobalReplaceDialog() {
	  
	    this.reportGlobalReplaceDialog.setVisible(true);
	  }
