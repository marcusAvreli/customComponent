package customComponent.project;
...
import customComponent.model.knowledgebase.dao.FactoryDAO;
...
public class CurrentProject {
   ...
   */
  public void newProject() throws KnowledgeBaseException {

    if (! isKnowledbaseLoaded()) {

       try {
    	logger.info("new Project. connecting to database");      
        this.kbm = new KnowledgeBaseManager();
        //this.kbm.createKnowledgeBase(folderPath + File.separator + filePath);
        this.kbm.loadKnowledgeBase();
   ...
   */
  public void loadProject(String path) throws KnowledgeBaseException {
...
/*  public KnowledgeBaseVersion checkKnowledgeBaseVersion(String path) throws KnowledgeBaseException {
  ...
  public void addKnowledgeBaseStateObserver(KnowledgeBaseStateObserver observer) {
    ...
    logger.info("addKnowledgeBaseStateObserver:");
